...
import useChatMock from "@/components/mocked-chat";
...
//   });
  ...
  return (
    // <div>aka</div>
    <main className="flex flex-col h-[90vh] w-full max-w-3xl  items-center mx-auto border-2 border-red-400">
      <div className="flex flex-1 w-full overflow-y-scroll py-6">
        <ChatMessageList>
          {/* Initial Message */}
          {messages.length === 0 && (
