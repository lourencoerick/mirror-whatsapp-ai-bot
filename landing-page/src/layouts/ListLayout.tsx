...
export default function ListLayout({
  ...
  return (
    <>
      <div className=" min-h-[52vh] divide-y divide-gray-200 dark:divide-gray-700 max-w-5xl mx-auto px-4 sm:px-0">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <label>
              <span className="sr-only">Busque artigos</span>
              <input
                aria-label="Busque artigos"
                type="text"
        ...
        <ul>
          {!filteredBlogPosts.length && 'Sem artigos, no momento.'}
