...
Revision ID: 70570557ee45
Revises: 
Create Date: 2025-03-28 14:12:50.531211
...
def upgrade() -> None:
    ...
    sa.Column('agent_bot_id', sa.UUID(), nullable=True),
    ...
    sa.Column('webhook_type', sa.String(length=255), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'], ),
    sa.ForeignKeyConstraint(['inbox_id'], ['inboxes.id'], ),
    ...
    sa.Column('account_id', sa.UUID(), nullable=False),
    sa.Column('inbox_id', sa.UUID(), nullable=False),
    sa.Column('contact_inbox_id', sa.UUID(), nullable=False),
