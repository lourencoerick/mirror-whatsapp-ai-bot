...
async def intelligent_stage_analyzer_hook(
    ...
    num_samples = 100
    list_of_message_templates: List[Dict[str, str]] = MESSAGE_TEMPLATES.get(
    ...
    if list_of_message_templates:
        ...
        selected_templates = random.sample(
            list_of_message_templates, actual_sample_size
        )
        ...
        if not validation_step_found_and_matched:
            ...
            retry_instruction_message = SystemMessage(
                content=(
                    ...
                    "- DON'T repeat yourself using the same emojis or greeting on the same place of the message, MAKE the conversation fluid and natural.\n"
                    ...
                    "- NEVER confirm a appointment without call the create_appointment tool successfully before.\n"
