from sqlalchemy import Column, Integer, String, SmallInteger, ForeignKey, Index
...
class Inbox(BaseModel):
    ...
    enable_auto_assignment = Column(SmallInteger, nullable=True)
...
class InboxMember(BaseModel):
    ...
    __table_args__ = (Index("inbox_members_inbox_id_index", "inbox_id"),)
