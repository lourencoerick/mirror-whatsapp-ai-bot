...
class User(BaseModel):
    ...
    reset_password_sent_at = Column(DateTime(timezone=True), nullable=True)
    remember_created_at = Column(DateTime(timezone=True), nullable=True)
    sign_in_count = Column(Integer, nullable=False)
    current_sign_in_at = Column(DateTime(timezone=True), nullable=True)
