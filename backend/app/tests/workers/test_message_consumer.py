...
@pytest.mark.unit
def test_handle_message_updates_conversation_snapshot(
    mock_db,
    mock_get_or_create_message,
    mock_conversation_find_by_id,
    mock_update_last_message_snapshot,
    mock_input_queue,
    mock_output_queue,
    valid_message,
):
    mock_message = MagicMock(id=123, conversation_id=1)
    mock_get_or_create_message.return_value = mock_message
    mock_conversation_find_by_id.return_value = MagicMock(id=1)
    ...
    mock_update_last_message_snapshot.assert_called_once_with(
        mock_conversation_find_by_id.return_value,
        mock_message,
    )
